...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ludo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#00164633#;
   ...
   u00106 : constant Version_32 := 16#d976e2b4#;
   pragma Export (C, u00106, "ada__numerics__float_randomB");
   u00107 : constant Version_32 := 16#62aa8dd2#;
   pragma Export (C, u00107, "ada__numerics__float_randomS");
   u00108 : constant Version_32 := 16#93bf75e3#;
   pragma Export (C, u00108, "system__random_numbersB");
   u00109 : constant Version_32 := 16#f1b831a2#;
   pragma Export (C, u00109, "system__random_numbersS");
   u00110 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00110, "system__random_seedB");
   u00111 : constant Version_32 := 16#69b0a863#;
   pragma Export (C, u00111, "system__random_seedS");
   u00112 : constant Version_32 := 16#57c21ad4#;
   pragma Export (C, u00112, "ada__calendarB");
   u00113 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00113, "ada__calendarS");
   u00114 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00114, "system__os_primitivesB");
   u00115 : constant Version_32 := 16#355de4ce#;
   ...
   u00117 : constant Version_32 := 16#532ab656#;
   pragma Export (C, u00117, "system__task_lockS");
   u00118 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00118, "system__win32__extS");
   u00119 : constant Version_32 := 16#5276dcb7#;
   pragma Export (C, u00119, "system__val_unsB");
   u00120 : constant Version_32 := 16#59698e93#;
   pragma Export (C, u00120, "system__val_unsS");
   u00121 : constant Version_32 := 16#553ad4ac#;
   pragma Export (C, u00121, "ada__real_timeB");
   u00122 : constant Version_32 := 16#1ad7dfc0#;
   pragma Export (C, u00122, "ada__real_timeS");
   u00123 : constant Version_32 := 16#0d140719#;
   pragma Export (C, u00123, "system__taskingB");
   u00124 : constant Version_32 := 16#c6674d66#;
   pragma Export (C, u00124, "system__taskingS");
   u00125 : constant Version_32 := 16#dc410cef#;
   pragma Export (C, u00125, "system__task_primitivesS");
   u00126 : constant Version_32 := 16#4cfe4fc8#;
   pragma Export (C, u00126, "system__os_interfaceS");
   u00127 : constant Version_32 := 16#1d638357#;
   pragma Export (C, u00127, "interfaces__c__stringsB");
   u00128 : constant Version_32 := 16#f239f79c#;
   pragma Export (C, u00128, "interfaces__c__stringsS");
   u00129 : constant Version_32 := 16#152ee045#;
   pragma Export (C, u00129, "system__task_primitives__operationsB");
   u00130 : constant Version_32 := 16#5a0b0d58#;
   ...
   u00146 : constant Version_32 := 16#53ec87f8#;
   pragma Export (C, u00146, "system__img_enum_newS");
   u00147 : constant Version_32 := 16#617d5887#;
   pragma Export (C, u00147, "system__stack_usageB");
   u00148 : constant Version_32 := 16#3a3ac346#;
   pragma Export (C, u00148, "system__stack_usageS");
   u00149 : constant Version_32 := 16#c6ca4532#;
   pragma Export (C, u00149, "ada__strings__unboundedB");
   u00150 : constant Version_32 := 16#6552cb60#;
   pragma Export (C, u00150, "ada__strings__unboundedS");
   u00151 : constant Version_32 := 16#144f64ae#;
   pragma Export (C, u00151, "ada__strings__searchB");
   u00152 : constant Version_32 := 16#c1ab8667#;
   pragma Export (C, u00152, "ada__strings__searchS");
   u00153 : constant Version_32 := 16#f9576a72#;
   pragma Export (C, u00153, "ada__tagsB");
   u00154 : constant Version_32 := 16#b6661f55#;
   pragma Export (C, u00154, "ada__tagsS");
   u00155 : constant Version_32 := 16#796f31f1#;
   pragma Export (C, u00155, "system__htableB");
   u00156 : constant Version_32 := 16#b66232d2#;
   pragma Export (C, u00156, "system__htableS");
   u00157 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00157, "system__string_hashB");
   u00158 : constant Version_32 := 16#143c59ac#;
   ...
   u00170 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00170, "ada__streamsB");
   u00171 : constant Version_32 := 16#67e31212#;
   pragma Export (C, u00171, "ada__streamsS");
   u00172 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00172, "system__finalization_rootB");
   u00173 : constant Version_32 := 16#7d52f2a8#;
   ...
   u00175 : constant Version_32 := 16#49d6668f#;
   ...
   u00178 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00178, "system__atomic_countersB");
   u00179 : constant Version_32 := 16#86fcacb5#;
   pragma Export (C, u00179, "system__atomic_countersS");
   u00180 : constant Version_32 := 16#5252521d#;
   pragma Export (C, u00180, "system__stream_attributesB");
   u00181 : constant Version_32 := 16#d573b948#;
   pragma Export (C, u00181, "system__stream_attributesS");
   u00182 : constant Version_32 := 16#3e25f63c#;
   pragma Export (C, u00182, "system__stream_attributes__xdrB");
   u00183 : constant Version_32 := 16#2f60cd1f#;
   pragma Export (C, u00183, "system__stream_attributes__xdrS");
   u00184 : constant Version_32 := 16#4ce79421#;
   pragma Export (C, u00184, "system__fat_lfltS");
   u00185 : constant Version_32 := 16#99935d6d#;
   pragma Export (C, u00185, "system__fat_sfltS");
   u00186 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00186, "ada__text_ioB");
   u00187 : constant Version_32 := 16#03e83e15#;
   pragma Export (C, u00187, "ada__text_ioS");
   u00188 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00188, "interfaces__c_streamsB");
   u00189 : constant Version_32 := 16#b1330297#;
   pragma Export (C, u00189, "interfaces__c_streamsS");
   u00190 : constant Version_32 := 16#ec9c64c3#;
   pragma Export (C, u00190, "system__file_ioB");
   u00191 : constant Version_32 := 16#95d1605d#;
   pragma Export (C, u00191, "system__file_ioS");
   u00192 : constant Version_32 := 16#cf3f1b90#;
   pragma Export (C, u00192, "system__file_control_blockS");
   u00193 : constant Version_32 := 16#ebe62790#;
   pragma Export (C, u00193, "ada__text_io__unbounded_ioS");
   u00194 : constant Version_32 := 16#013bf30d#;
   pragma Export (C, u00194, "ada__strings__unbounded__text_ioB");
   u00195 : constant Version_32 := 16#9e7a4c9c#;
   pragma Export (C, u00195, "ada__strings__unbounded__text_ioS");
   u00196 : constant Version_32 := 16#72e59739#;
   pragma Export (C, u00196, "system__tasking__rendezvousB");
   u00197 : constant Version_32 := 16#e93c6c5f#;
   ...
   u00199 : constant Version_32 := 16#dbc9df38#;
   pragma Export (C, u00199, "system__restrictionsS");
   u00200 : constant Version_32 := 16#4cd3ce3b#;
   ...
   u00202 : constant Version_32 := 16#b19e9df1#;
   ...
   u00204 : constant Version_32 := 16#215cb8f4#;
   ...
   u00207 : constant Version_32 := 16#6fde25af#;
   pragma Export (C, u00207, "ada__exceptions__is_null_occurrenceS");
   u00208 : constant Version_32 := 16#d798575d#;
   ...
   u00210 : constant Version_32 := 16#3af67f9c#;
   ...
   u00212 : constant Version_32 := 16#119b2d0b#;
